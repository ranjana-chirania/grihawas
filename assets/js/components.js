...
(function () {
  ...
  const NAV_LINKS = [
    ...
    { href: "admin-login.html", label: "Admin Login", key: "admin-login" },
  ];
  ...
  function renderFabs() {
    ...
    mount.innerHTML =
      ...
      (hasPhone ? "" : " is-unavailable") +
      '" href="' +
      (hasPhone ? "tel:" + phoneNum : "contact.html") +
      '" aria-label="Call us">' +
    ...
    if (quickEnquiry)
      quickEnquiry.addEventListener("click", function () {
  ...
  function renderFooter() {
    ...
    mount.innerHTML =
      ...
      '<a href="' +
      CFG.SOCIAL.facebook +
      '" aria-label="Facebook" target="_blank" rel="noopener"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M13.5 21v-8h2.7l.4-3.1h-3.1V8c0-.9.25-1.5 1.55-1.5H16.7V3.7C16.4 3.66 15.4 3.57 14.24 3.57c-2.4 0-4.04 1.47-4.04 4.16V9.9H7.5V13h2.7v8h3.3z"/></svg></a>' +
      '<a href="' +
      CFG.SOCIAL.instagram +
      '" aria-label="Instagram" target="_blank" rel="noopener"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="0.6" fill="currentColor" stroke="none"/></svg></a>' +
      '<a href="' +
      CFG.SOCIAL.linkedin +
      '" aria-label="LinkedIn" target="_blank" rel="noopener"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M6.94 8.5H3.56V20h3.38V8.5zM5.25 3.5a1.96 1.96 0 1 0 0 3.92 1.96 1.96 0 0 0 0-3.92zM20.44 20h-3.37v-5.9c0-1.4-.03-3.2-1.95-3.2-1.96 0-2.26 1.53-2.26 3.1V20H9.5V8.5h3.24v1.57h.05c.45-.85 1.55-1.75 3.2-1.75 3.42 0 4.05 2.25 4.05 5.17V20z"/></svg></a>' +
      '<a href="' +
      CFG.SOCIAL.youtube +
      ...
      '<a href="' +
      CFG.GOOGLE_MAP_URL +
      '" target="_blank" rel="noopener noreferrer"><span>Visit</span>' +
      CFG.ADDRESS_LINE_1 +
      "<br>" +
      CFG.ADDRESS_LINE_2 +
      "</a>" +
      ...
      "</footer>";
    mount
      .querySelectorAll('.footer-social a[href=""]')
